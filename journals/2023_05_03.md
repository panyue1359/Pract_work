...
- 需求：尽量保持原始排版，正确转换公式符号，双语对照，术语翻译保持一致
- AiNiee：调用大模型API翻译文档，可详细设置翻译风格、术语表、人物特点等等，自动生成中文及双语文档，而且可以自定义双语文字样式 [NEKOparapa/AiNiee: 一款专注于Ai翻译的工具，一键自动翻译RPG SLG游戏，Epub TXT小说，PDF Word MD文档，Srt Vtt Lrc字幕等等复杂长文本。](https://github.com/NEKOparapa/AiNiee)
- 浏览器沉浸式翻译插件：自带文档翻译功能，可自行配置第三方大模型API，生成中文及双语文档 [沉浸式翻译 - 文档双语翻译：一键翻译 PDF，ePub 电子书，字幕文件，txt 文件](https://app.immersivetranslate.com/)
...
- ChatGPT擅长约束优化：GPT的原理是“合理拼接”，本质上是在一个解空间中按照某种原则搜索“下一个字”。如果不加限制，搜索到的结果很可能偏离我们的预期，而指令工程的作用就是限制和引导搜索方向，以使之符合我们的预期。类比解谜游戏设计，现在ChatGPT变成了“玩家”，而用户变成了设计师。
