...
- DualSPHysics：SPH软件，支持导入FreeCAD生成的stl文件 [DualSPHysics/DualSPHysics: C++/CUDA/OpenMP based Smoothed Particle Hydrodynamics (SPH) Solver](https://github.com/DualSPHysics/DualSPHysics)
