...
- ## KeePass
  id:: 69f97d1b-a3e0-4e52-b8db-b4d3966c62d9
  collapsed:: true
	- ((65030192-d6e7-4fac-823d-a9ede88df32a))
	  collapsed:: true
		- collapsed:: true
...
- 自动输入：匹配窗口标题，模拟键盘自动输入用户名和密码，默认快捷键Ctrl+Shift+A。右键左侧栏数据库图标，选择“编辑群组”，点“自动输入”，在“代替默认序列为(0)”中输入规则。[软件教程 篇一：从入门到熟练：KeePass全网最详使用指南_服务软件_什么值得买](https://post.smzdm.com/p/713042/)
	- 例如`+{DELAY 100}{CLEARFIELD}{USERNAME}{TAB}{PASSWORD}{ENTER}`，表示按下Shift键（Windows10输入法切换），等待100毫秒，清空输入框，输入用户名，Tab键（换行），输入密码，回车键。”
- 修改数据库路径：打开KeePass.config.xml和KeePass.config.enforced文件，修改其中的数据库路径
- 便携版升级：将“KeePass.config.xml”、“Language”文件夹和“Plugins”文件夹复制到新程序文件夹 [KeePass 绿色便携版升级注意事项 - 扬阳 - 博客园](https://www.cnblogs.com/vaemaxsky/p/15315996.html)