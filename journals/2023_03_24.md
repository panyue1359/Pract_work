...
- 指令优化工具：github检索词`in:discription prompt optimize (ai OR llm)` [Repository search results](https://github.com/search?q=in%3Adiscription+prompt+optimize+%28ai+OR+llm%29&type=repositories)
- ## 常用指令库
