...
- 制表符对齐法：搜索“插入对齐制表位”命令，在公式开头插入居中对齐制表位，末尾插入右对齐制表位，然后添加序号。缺点是公式将以内嵌形式显示。 [Word公式格式及编号设置！！！ - nlgq的文章 - 知乎](https://zhuanlan.zhihu.com/p/1898559248260142883)
- 表格对齐法：插入一行三列表格，中间放公式居中对齐，右边放序号右对齐，修改单元格格式右边距为0，最后隐藏边框
- ## Word符号加上划线
  collapsed:: true
	- ((6423a4ae-416b-4cdd-8f08-44e5a4999c72))
	  collapsed:: true
