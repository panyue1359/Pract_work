	  ...
	  collapsed:: true
		- collapsed:: true
		  >参考
			...
			- ((6968827a-8224-45c4-8e3f-23c2ee89b127))
- PillOCR：通过API Key调用在线大模型识别含公式的图片，返回Markdown格式的结果，识别效果取决于所调用的大模型，实测gemini-2.5-flash-thinking模型识别效果极佳，详见“PillOCR公式识别”条目
